...
Add authoring and graded exercises, profiles, reputation, votes, notifications, moderation, search indexing and collaboration. Forums, votes, follows, notifications, activity feeds, site search, medals, tiers and rankings are implemented ([community](community.md)); authoring, graded exercises, search indexing and collaboration remain. Complete responsive/accessibility audits and end-to-end regression coverage. Exit criterion: administrators can operate the community, publish learning content and handle abuse without direct database edits.
